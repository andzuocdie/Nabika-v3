...
def title():
    ...
    stdout.write("             "+Fore.LIGHTGREEN_EX+"│           _   _   ___  ______ _____ _   __  ___              │\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX+"│          | \ | | / _ \ | ___ \_   _| | / / / _ \             │\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX+"│          |  \| |/ /_\ \| |_/ / | | | |/ / / /_\ \            │\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX+"│          | . ` ||  _  || ___ \ | | |    \ |  _  |            │\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX+"│          | |\  || | | || |_/ /_| |_| |\  \| | | |            │\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX+"│          \_| \_/\_| |_/\____/ \___/\_| \_/\_| |_/            │\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX+"│                                                              │\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX+"│         CODE ĐƯỢC HOÀN THIỆN BỞI BẢO AN - NGOC PHUC          │\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX+"╰──────────────────────────────────────────────────────────────╯\n")

    stdout.write("             "+Fore.LIGHTGREEN_EX+"╔══════════════════════════════════════════════════════════════╗\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX+"║ "+Fore.LIGHTWHITE_EX   +"     Tool DDoS By NABIKA TEAM"+Fore.LIGHTGREEN_EX  +"                                ║\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX+"║ "+Fore.LIGHTWHITE_EX   +"     Copyright : Nguyễn Nhật BẢo An & Ngọc Phúc (NABIKA)    "+Fore.LIGHTGREEN_EX  +" ║\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX+"║ "+Fore.LIGHTWHITE_EX   +"     Zalo Contact : 0985245579 & 0933452441  "+Fore.LIGHTGREEN_EX  +"                ║\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX+"║ "+Fore.LIGHTWHITE_EX   +"     Nhập Lệnh 'nabika' Để Chạy Ddos    "+Fore.LIGHTGREEN_EX +"                     ║\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX+"╚══════════════════════════════════════════════════════════════╝\n")
    stdout.write("\n")
##############################################################################################
def command():
...
##############################################################################################     
        ...
        target = input()
        try:
            r = requests.get(f"https://api.proxyscrape.com/?request=displayproxies&proxytype=socks5&timeout=10000&country=all")
            print(r.text)
        except:
        ...
        target = input()
        try:
            r = requests.get(f"https://www.proxy-list.download/api/v1/get?type=socks5")
            print(r.text)
        except:
            print('An error has occurred while sending the request to the API!')
        ...
        target = input()
        try:
            r = requests.get(f"https://api.proxyscrape.com/?request=displayproxies&proxytype=http&timeout=10000&country=all")
            print(r.text)
        except:
            print('An error has occurred while sending the request to the API!')
    else:
